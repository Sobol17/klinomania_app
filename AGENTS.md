...
This is a Flutter app named `time2clean`. Application startup lives in `lib/main.dart`, shared initialization in `lib/bootstrap.dart`, and app-level providers/navigation in `lib/app/app.dart`.
